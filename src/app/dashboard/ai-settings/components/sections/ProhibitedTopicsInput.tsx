...
interface ProhibitedTopicsInputProps {
    topics: string[];
    onChange: (next: string[]) => void;
}

export function ProhibitedTopicsInput({ topics, onChange }: ProhibitedTopicsInputProps) {
    ...
    return (
        <div>
            <label className={labelCls}>Хориглосон сэдвүүд</label>
            <p className="text-[11.5px] text-white/45 mb-3 leading-relaxed">
                Эдгээр сэдвээр асуугдсан тохиолдолд AI хариулахгүй, эелдгээр татгалзана. Жишээ нь: "улс төр", "өрсөлдөгчдийн үнэ".
            </p>
            ...
            <div className="flex gap-2 mb-3">
                <input
                    ...
                    placeholder="Сэдэв оруулаад Enter дарна уу"
                    className={inputCls}
                />
                <button
                    type="button"
            ...
            {topics.length > 0 ? (
                ...
                <p className="text-[11.5px] text-white/30 italic">Хориглосон сэдэв байхгүй.</p>
            )}
        </div>
    );
}
