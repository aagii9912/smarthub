...
export interface ZaawarTopic {
    id: string;
    title: string;
    /** Bubble доторх богино шошго (2 мөрөнд багтахаар) — байхгүй бол title-ийг ашиглана */
    label?: string;
...
/** Массивын дараалал = хөтөчийн үзүүлэх дараалал (badge-ийн дугаар нь index + 1) */
export const ZAAWAR_TOPICS: ZaawarTopic[] = [
    ...
    },
    {
        ...
        short: "Тохируулгын алхмуудаар дэлгүүрээ бүрэн бэлэн болгоно.",
        icon: Plug,
        pos: { x: 105, y: 330 },
        color: violet,
        steps: [
            ...
            { title: "Бараа, үйлчилгээ бүртгэх", desc: "Зарах бараа, үйлчилгээгээ нэр, үнэ, зураг, тоотойгоор оруулна. Бизнесийн төрлөөс хамаарч энэ алхам «Меню», «Үйлчилгээ» гэх мэт нэртэй байж болно." },
            { title: "Үйл ажиллагааны тохиргоо", desc: "Бизнесийн төрлөөсөө хамаарсан нэмэлт тохиргоог хийнэ — дэлгүүрт агуулах, НӨАТ; ресторанд ширээ, хүргэлт гэх мэт (заавал биш; зарим төрөлд энэ алхам гарахгүй)." },
            ...
            { title: "Төлөвлөгөө сонгох", desc: "Сүүлийн «Төлбөр» алхамд бизнестээ тохирсон багцаа сонгоно. Бэлэн боллоо! 🎉" },
        ],
    ...
    },
    {
        ...
        color: cyan,
        steps: [
            { title: "Бүтээгдэхүүн хэсэг рүү орох", desc: "Хяналтын самбараас «Бүтээгдэхүүн» цэсийг сонгоно." },
            { title: "Бараа нэмэх", desc: "«Шинэ нэмэх» товчийг дараад нэр, үнэ, зураг, үлдэгдлээ оруулна." },
    ...
    },
    {
        ...
        short: "Постны коммент бүрт AI автоматаар хариулж, чат руу чиглүүлнэ. Энэ боломж дэлгүүрүүдэд шат дараатай нээгдэж байна.",
        icon: Zap,
        pos: { x: 895, y: 215 },
        color: amber,
        steps: [
            { title: "Автоматжуулалт үүсгэх", desc: "«Comment Удирдлага» хэсгээс пост сонгоно." },
        ...
        tip: "Таны самбарт «Тун удахгүй» гэж харагдаж байвал энэ боломж таны дэлгүүрт удахгүй нээгдэнэ. Идэвхжсэн үед идэвхтэй пост дээрээ автоматжуулалт тавихад борлуулалт хамгийн их өсдөг.",
