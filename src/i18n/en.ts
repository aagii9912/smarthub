...
export const en: Translations = {
  ...
  auth: {
    ...
    forgotPasswordSent: 'Reset link sent. Please check your inbox.',
    ...
    resetSessionMissing: 'Reset link is invalid or expired. Please try again.',
  },
  ...
  sidebar: {
    ...
    messages: 'Messages',
    aiReport: 'AI Report',
    paymentAudit: 'Payment Information',
  ...
  header: {
    pageTitles: {
      ...
      '/dashboard/payment-audit': 'Payment Information',
  ...
  dashboard: {
    ...
    seconds: 'seconds',
    // ─── Booking archetype (service / beauty / healthcare) ───
    bookingEyebrow: 'ACTIVE APPOINTMENTS',
    bookingSubtitle: "Today's appointment activity. The AI agent is actively handling {count} customers.",
    bookingCta: 'Add service',
    kpiPeriodAppointments: 'Appointments',
    kpiUpcoming: 'Upcoming',
    kpiNoShow: 'No-show (%)',
    kpiCompleted: 'Completed',
    upcomingTitle: 'Upcoming appointments',
    upcomingSubtitle: 'Nearest scheduled bookings',
    noAppointments: 'No appointments',
    noAppointmentsDesc: 'New appointments will appear here',
    colService: 'Service',
    colTime: 'Time',
    apptChart: 'Appointments this period',
    ...
    minutesShort: 'min',
    // ─── Lead archetype (realestate_auto / education) ───
    leadEyebrow: 'LEAD MANAGEMENT',
    leadSubtitle: 'New lead activity. The AI agent is actively handling {count} customers.',
    leadCta: 'Add customer',
    kpiNewLeads: 'New leads',
    kpiQualified: 'Contacts captured',
    kpiConverted: 'Converted',
    kpiLeadConversion: 'Conversion (%)',
    recentLeadsTitle: 'Recent leads',
    recentLeadsSubtitle: 'Newly added customers',
    noLeads: 'No leads',
    noLeadsDesc: 'New leads will appear here',
    colLead: 'Customer',
    colPhone: 'Phone',
    colJoined: 'Joined',
    leadBadgeConverted: 'Converted',
    ...
    followUpSubtitle: 'Left a phone but not reached in 24h',
    followUpMarkContacted: 'Contacted',
    kpiPhoneCaptureRate: 'Phone capture rate',
    followUpBacklogLabel: 'Leads awaiting a call',
    missedCommentsLabel: 'Uncaptured phone comments',
    sourceComment: 'Comments',
    followUpMarkedContacted: 'Marked',
