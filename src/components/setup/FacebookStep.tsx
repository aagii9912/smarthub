          ...
          <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
            {fbPages.map((page) => (
              <button
                ...
                disabled={saving}
                className={`w-full p-4 rounded-xl border transition-all flex items-center gap-3 shadow-sm ${selectedPageId === page.id
            ...
            <div className="mt-4 space-y-4 pt-4 border-t border-gray-100">
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white shadow-sm border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                />
                <input
                  type="text"
                  value={manualPageId}
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-white shadow-sm border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none text-sm font-mono transition-all"
                />
                <button
